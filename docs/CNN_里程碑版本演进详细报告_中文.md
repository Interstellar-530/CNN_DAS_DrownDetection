...
|---|---|---:|---:|---|---:|---:|---:|---:|---:|---:|
| **01** | 初始基线：轻量 CNN，4450 条，严重失衡 | 16 | 0.25 | macro-F1 | 0.457 | 0.564/0.443 | 0.62/0.25 | 0.46/0.58 | 0.146 | 0.063 |
| **02** | V2 结构 + FSD50K 尖叫，GPU | 32 | 0.30 | 尖叫F1 | 0.600 | 0.620/0.609 | 0.78/0.95 | 0.65/0.52 | 0.491 | 0.294 |
| **03** | 回火：macro-F1、加强正则 | 32 | 0.40 | macro-F1 | 0.651 | 0.758/0.679 | 0.85/0.97 | 0.81/0.42 | 0.406 | 0.201 |
| **04** | 数据重平衡 | 48 | 0.35 | 准确率 | 0.674 | 0.745/0.701 | 0.85/0.97 | 0.87/0.45 | 0.439 | 0.228 |
| **05** | 标签对齐 + 均衡数据 | 48 | 0.50 | 尖叫F1 | 0.594 | 0.657/0.606 | 0.83/0.62 | 0.69/0.52 | 0.323 | 0.083 |
| **06** | reference 配方 + 均衡数据 | 32 | 0.40 | macro-F1 | 0.611 | 0.703/0.626 | 0.86/0.78 | 0.72/0.48 | 0.375 | 0.099 |
| **07** | +89 条真实 FSD50K 水声 | 48 | 0.50 | 尖叫F1 | 0.651 | 0.704/0.647 | 0.84/0.68 | 0.73/0.68 | 0.461 | 0.092 |
| **08** | +55 条全新 dev 尖叫（最终） | 48 | 0.50 | 尖叫F1 | 0.646 | 0.710/0.652 | 0.83/0.88 | 0.67/0.60 | 0.525 | 0.135 |
| **09** | 双召回目标（min 尖叫R, 落水R） | 48 | 0.50 | 双召回 | 0.651 | 0.670/0.638 | 0.64/0.97 | 0.68/0.73 | 0.715 | 0.383 |
| **10** | 08 配方 + 80 epoch | 48 | 0.50 | 尖叫F1 | 0.680 | 0.729/0.687 | 0.81/0.95 | 0.71/0.62 | 0.586 | 0.205 |
| **11** | 数据清洗 + 结构优化重训（后期优化） | 32 | 0.40 | macro-F1 | 0.743 | 0.823/0.766 | 0.97/0.95 | 0.89/0.55 | 0.522 | 0.063 |
| **12** | 概率融合（0.5/0.5）：水声强 + 尖叫强 | 48 | 0.50 | 概率融合 | 0.686 | 0.732/0.686 | 0.85/0.82 | 0.71/0.68 | 0.564 | 0.109 |
| **13** | 11 在 v3.6 微调 + 1.5× 水声权重（最终） | 32 | 0.40 | 微调 | 0.754 | 0.801/0.761 | 0.95/0.95 | 0.85/0.68 | 0.649 | 0.109 |
